import { Search, ScrollText, NotebookPen, TabletSmartphone, Users, Info, Heart, Mail, Phone, Server, Code, Palette, ShieldUser } from "lucide-react"
...
export const infoData = [
    {
        icon: Users,
        title: "User-Friendly",
        description: "Easy-to-use interface with smooth navigation and clean layout."
    },
    {
        icon: Mail,
        title: "Email Ready",
        description: "Every contact includes email support and integration-ready format."
    },
    {
        icon: Phone,
